	...
	if(!window.svgEditor) window.svgEditor = function($) {
		...
		var defaultPrefs = {
			...
			curConfig = {
				...
				langPath: 'locale/',
				extPath: 'extensions/',
				extensions: ['ext-class.js', 'ext-markers.js','ext-connector.js', 'ext-eyedropper.js'],
				initTool: 'select',
				wireframe: false
			},
			uiStrings = {
		...
		Editor.init = function() {
			...
			var setSelectMode = function() {
				...
				// To change the mouseover cursor during selection mode. This should also be changed in setSelectMode() to make it work.
